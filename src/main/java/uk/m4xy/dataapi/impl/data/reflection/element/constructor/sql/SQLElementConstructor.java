...
public class SQLElementConstructor<T extends ReflectiveDataType<T, ?, O, ?>, O extends ReflectedDataObject<T, ?, O, ?>> implements AnnotationReflectiveElementConstructor<SQLElement, T, O> {
